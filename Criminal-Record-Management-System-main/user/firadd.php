...
if (isset($_POST['report'])) {
    ...
    $sql = "INSERT INTO `fir` (`firname`, `firfathername`, `firmothername`, `IDnumber`, `phno`, `email`, `datetime`, `placeocc`,  `address`, `crimedesc`) VALUES ('$name', '$fathername', '$mothername', '$aadhar', '$phno', '$email', '$dt', '$place', '$addr', '$desc')";
                            ...
                            <div class="content">
                                <form method="POST" action="firadd.php">
                                    <div class="user-details">
                                        ...
                                        <div class="input-box">
                                            <span class="details"><label for="aadhar">Complainant's IDNumber:</label></span>
                                            <input type="number" name="aadhar" placeholder="Enter the Complainant's ID Number" id="aadhar"  required>
                                        </div>
                                        <div class="input-box">
