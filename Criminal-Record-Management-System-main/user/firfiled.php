...
if ($search) {
    $sql = "SELECT * FROM fir WHERE `IDnumber` LIKE '%$search%' OR `firname` LIKE '%$search%' OR `firfathername` LIKE '%$search%' OR `firmothername` LIKE '%$search%' OR `aadhar` LIKE '%$search%' OR `phno` LIKE '%$search%' OR `email` LIKE '%$search%' OR `datetime` LIKE '%$search%' OR `placeocc` LIKE '%$search%' OR `address` LIKE '%$search%' OR `crimedesc` LIKE '%$search%' OR `status` LIKE '%$search%'";
} else {
