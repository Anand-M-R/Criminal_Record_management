...
<head>
    <title>CRMS</title>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="../police/css/content.css">
        ...
        <nav>
            ...
            <div>
                <button type="button" class="add_button">
                    <span class="add_button_text"><a href="police_criminaladd.php">Add</a></span>
                                ...
                                <div class="end_button">
                                    <div class="in_button">
                                        <button type="button" class="update_button">
                                            <span class="update_button_text"><a href="police_criminalupdate.php?id=<?php echo $criminal['Crino'] ?>">Update</a></span>
