...
if (isset($_POST['report'])) {
    ...
    $sql = "INSERT INTO `fir` (`firname`, `firfathername`, `firmothername`, `IDnumber`, `phno`, `email`, `datetime`, `placeocc`,  `address`, `crimedesc`, `status`) VALUES ('$name', '$fathername', '$mothername', '$aadhar', '$phno', '$email', '$dt', '$place', '$addr', '$desc', 'Pending')";
                                ...
                                <form action="fir.php?id=<?php echo $user_id ?>" method="POST">
                                    <div class="user-details">
                                        ...
                                        <div class="input-box">
                                            ...
                                            <input type="tel" id="adhar" name="aadhar"  placeholder="Enter Your ID Number" required>
                                        </div>
