...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE `fir` SET `IDnumber` = '$fir_id', `firname` = '$name', `firfathername` =  '$fathername',`firmothername` =  '$mothername', `IDnumber` = '$id_num', `phno` = '$phno', `email` = '$email', `datetime` = '$dt', `placeocc` = '$place', `address` = '$addr', `crimedesc`= '$desc', `status` = '$status' WHERE `IDnumber` = '$fir_id'";
...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM `fir` WHERE `IDnumber` = $fir_id";
