        ...
        <nav>
            ...
            <div>
                <button type="button" class="add_button">
                    <span class="add_button_text"><a href="policeadd.php">Add</a></span>
                                ...
                                <div class="end_button">
                                    <div class="in_button">
                                        <button type="button" class="update_button">
                                            <span class="update_button_text"><a href="policeupdate.php?id=<?php echo $police['Poid'] ?>">Update</a></span>
                                    ...
                                    <div class="in_button">
                                        <form method="POST" action="policedelete.php">
                                            <input type="hidden" name="id" value="<?php echo $police['Poname'] ?>" />
