...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE `crime` SET `Criname` = '$crimname', `Cricomm` =  '$crimcom', `Cridt` =  '$crimdatme', `Jailsen` = '$jailsent' WHERE `Crino` = $cri_id";
                                ...
                                <form method="POST">
                                    <div class="user-details">
                                        <div class="input-box">
                                            ...
                                            <input type="text" placeholder="Enter the Criminal Number" name="CriminalNo" id="Criminal Number" value="<?php echo $crim_no ?>" required disabled>
                                        </div>
                                        <div class="input-box">
