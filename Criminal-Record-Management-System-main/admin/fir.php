...
if ($search) {
    $sql = "SELECT * FROM fir WHERE `IDnumber` LIKE '%$search%' OR `firname` LIKE '%$search%' OR `firfathername` LIKE '%$search%' OR `firmothername` LIKE '%$search%' OR `IDnumber` LIKE '%$search%' OR `phno` LIKE '%$search%' OR `email` LIKE '%$search%' OR `datetime` LIKE '%$search%' OR `placeocc` LIKE '%$search%' OR `address` LIKE '%$search%' OR `crimedesc` LIKE '%$search%' OR `status` LIKE '%$search%'";
} else {
    $sql = 'SELECT * FROM fir ORDER BY IDnumber';
}
                ...
                <?php foreach ($firs as $fir) { ?>
                    <div class="box">
                        <div class="right-side">
                            <div class="text">
                                <!-- <p><b>FIR ID: </b><?php echo htmlspecialchars($fir['IDnumber']); ?></p> -->
                                ...
                                <div class="end_button">
                                    <div class="in_button">
                                        <button type="button" class="update_button">
                                            <span class="update_button_text"><a href="firupdate.php?id=<?php echo $fir['IDnumber'] ?>">Update</a></span>
                                    ...
                                    <div class="in_button">
                                        <form method="POST" action="firdelete.php">
                                            <input type="hidden" name="id" value="<?php echo $fir['IDnumber'] ?>" />
