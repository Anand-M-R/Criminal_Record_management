                                ...
                                <form method="POST">
                                    <div class="user-details">
                                        <div class="input-box">
                                            ...
                                            <input type="text" placeholder="Enter the Criminal Number" name="CriminalNo" id="Criminal Number" pattern="[0-9]{6}" value="<?php echo $crim_id ?>" required>
                                        </div>
                                        <div class="input-box">
                                    ...
                                    <div class="goback">
                                        <a href="criminal.php"><input type="button" onclick="" value="Go Back"></a>
                                    </div>
                                </form>
                            </div>
                        </div>
